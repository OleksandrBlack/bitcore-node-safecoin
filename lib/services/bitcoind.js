  ...
  this.client.getInfo(function(err, response) {
    ...
    self.client.getNetworkInfo(function(err, netResponse) {
      ...
      var info = {
        ...
        notarizedhash: result.notarizedhash,
        notarizedtxid: result.notarizedtxid,
...
Bitcoin.prototype.getActiveNodes = function(callback) {
  var self = this;
  this.client.getActiveNodes(function(err, response) {
  if (err) {
    return callback(self._wrapRPCError(err));
  }
  var result = response;
