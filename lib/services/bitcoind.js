 ...
 *   "currentblocksize": 0,
 *   "currentblocktx": 0,
 *   "difficulty": 6156276.985964426,
 *   "errors": "",
 *   "genproclimit": -1,
 *   "localsolps": 0,
 *   "networksolps": 340494871,
 *   "networkhashps": 340494871,
 *   "pooledtx": 13,
 *   "testnet": false,
 *   "chain": "main",
 *   "generate": false
...
Bitcoin.prototype.getMiningInfo = function(callback) {
  ...
  this.client.getMiningInfo(function(err, response) {
    ...
    var miningInfo = {
      blocks: result.blocks,
      currentblocksize: result.currentblocksize,
      currentblocktx: result.currentblocktx,
      difficulty: result.difficulty,
      errors: result.errors,
      genproclimit: result.genproclimit,
      localsolps: result.localsolps,
      networksolps: result.networksolps,
