...
var BASE_PACKAGE = {
  description: 'A full Safecoin node build with Bitcore',
  repository: 'https://github.com/Fair-Exchange/bitcore-node-safecoin',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-safecoin': 'git+ssh://git@github.com:Fair-Exchange/bitcore-lib-safecoin',
    'bitcore-node-safecoin': 'git+ssh://git@github.com:Fair-Exchange/bitcore-node-safecoin#dev' //TODO dev branch
  }
};
